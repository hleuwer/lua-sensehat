...
print(table.concat({
         "ATTENTION: Don't be surprised. This application is much slower in Lua than in Python!",
         "           The reason is simply that we have to ",
         "           a) parse snippets of Python code for every call to setPixels (or set_pixels",
         "              in Python).",
         "           b) convert the pixel map in table format into Python list format.",
         " ",
         "           This is the price we have to pay for convenience :-).",
         " ",
